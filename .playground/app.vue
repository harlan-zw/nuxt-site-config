...
<div class="flex flex-col min-h-screen">
  <header class="sticky top-0 z-50 w-full backdrop-blur flex-none border-b border-gray-900/10 dark:border-gray-50/[0.06] bg-white/75 dark:bg-gray-900/75">
    <UContainer class="py-3">
      ...
      <div class="flex items-end gap-1.5 font-bold text-xl text-gray-900 dark:text-white">
        ...
        Nuxt
        <div class="text-primary-500 dark:text-primary-400">Site Config</div>
      </div>
      <p class="text-sm text-gray-600" v-if="$route.path !== '/'">
        <NuxtLink to="/">Back <Icon name="carbon:arrow-left" /></NuxtLink>
      </p>
      </div>
    </UContainer>
  </header>
  ...
  <footer class="text-sm text-gray-700 py-5">
