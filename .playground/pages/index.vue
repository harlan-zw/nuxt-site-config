...
import {ref, useSiteConfig} from '#imports'

const siteName = ref('My Site Name')
...
function changeSiteName() {
  siteName.value = 'New Name ' + counter++
}
</script>
<template>
<div>
  ...
  <UButton @click="changeSiteName">Change site name</UButton>
  <div class="mt-5">
