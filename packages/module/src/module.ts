  ...
  async setup(config, nuxt) {
    ...
    addTypeTemplate({
      ...
      getContents: (data) => {
        ...
        const nitroTypesModule = usesNitroV3 ? 'nitro/types' : 'nitropack'
        const eventContextModule = usesNitroV3 ? 'srvx' : 'h3'
        const eventContextType = usesNitroV3 ? 'ServerRequestContext' : 'H3EventContext'
        const hookEventType = usesNitroV3 ? '<import(\'nitro/h3\').H3Event>' : ''
        return `// Generated by nuxt-site-config

declare module '${nitroTypesModule}' {
  ...
  interface NitroRuntimeHooks {
    'site-config:init': (ctx: import('${typesPath}').HookSiteConfigInitContext${hookEventType}) => void | Promise<void>
  }
}

declare module '${eventContextModule}' {
