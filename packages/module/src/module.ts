    ...
    addTypeTemplate({
      ...
      getContents: (data) => {
        ...
        const nitroTypes = renderNitroTypeAugmentations(nitroCompatibility, {
          routeRules: `site?: import('${typesPath}').SiteConfigInput`,
          routeConfig: `site?: import('${typesPath}').SiteConfig`,
          runtimeHooks: `'site-config:init': (ctx: import('${typesPath}').HookSiteConfigInitContext<${nitroCompatibility.eventType}>) => void | Promise<void>`,
          eventContext: `siteConfig: import('${typesPath}').SiteConfigStack
...
`
      : `
export const hasMatchedRouteRules = false
export { getRouteRules as getNitroRouteRules } from 'nitropack/runtime'
`
